...
<p align="center">
    <a href="https://github.com/jonitoh/readme-examples" target="_blank">
        <img width="50%" src="assets/file-svgrepo-com.svg" alt="logo">
    </a>
</p>
...
<div>
<p align="center">
    Un super README à utiliser pour vos projets!
 </p>
</div>
<br/>
...
À part [Markdown](https://en.wikipedia.org/wiki/Markdown), il n'y a pas d'autres technologies.
...
Facile d'utilisation: clone le répertoire et voilà !

Le fichier `README-BLANK.md` fournit un patron épuré qui peut utiliser. Par contre, il est en anglais.
